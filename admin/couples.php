	...
	<body>
		<div id="wrapper">
			<div role='navigation' id="navbar">
				...
				<a href='couples.php' class='btn btn-primary btn-lg stButton active'>Couples</a>
		...
		<div id="scrolling-div" style="clear: both;">
		    <button class="btn btn-primary btn-lg stButton" onclick="saveOrder()" id="saveButton" origin="couples">Save</button>
			<a class="btn btn-primary btn-lg stButton" href="#loadModal" data-toggle="modal" role="button">Load</a>
			<button class="btn btn-primary btn-lg stButton" onclick="deleteImages()" id="deleteButton" origin="couples">Delete</button>
		</div>
					...
					<div class="modal-content">
						...
						<div class="modal-footer" style="border-top:none;">
							<div class="form-group">
								...
								<button type="submit" class="btn btn-primary btn-lg" name="couples">Upload</button>
							</div>
						</div>
					</div>
				</form>
